...
exports.bot_name = process.env['BOT_NAME'] || "status";

// WORK HERE
exports.other_bots = (process.env['OTHER_BOTS'] || '').split(",");

exports.config_path = path.join(path.dirname(__dirname), "config.json");

exports.db_host = '127.0.0.1';
exports.db_port = 3306;
exports.db_user = 'teamstatus';
exports.db_pass = undefined;
exports.database = 'teamstatus';
...
exports.deployment_url = "http://teamstat.us";
